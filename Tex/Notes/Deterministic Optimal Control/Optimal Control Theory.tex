...
\section{Motivating example} %the idea is to use a working example that we borrow all over the dissertation. Starting deterministic we get stochastic and generalize it
